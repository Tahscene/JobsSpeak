<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="JobListing.aspx.cs" Inherits="JobSpeakJobPortal.User.JobListing" %>
                        ...
                        <div class="job-category-listing mb-50 pb-0">
                            ...
                            <div class="single-listing">
                                ...
                                <div class="select-job-items2">
                                    <asp:DropDownList ID="ddlCountry" runat="server" CssClass="form-control w-100" DataSourceID="SqlDataSource1" AppendDataBoundItems="True" DataTextField="CountryName" DataValueField="CountryName" OnSelectedIndexChanged="ddlCountry_SelectedIndexChanged" AutoPostBack="True">
                            ...
                            <div class="select-Categories pt-80 pb-50">
                                ...
                                <div class="checkbox checkbox-primary">
                                    <asp:CheckBoxList ID="CheckBoxList1" runat="server" AutoPostBack="True" RepeatDirection="Vertical" RepeatLayout="Flow" CssClass="styled" TextAlign="Right" OnSelectedIndexChanged="CheckBoxList1_SelectedIndexChanged">
