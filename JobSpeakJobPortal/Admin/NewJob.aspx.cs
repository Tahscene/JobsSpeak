            ...
            if (Request.QueryString["id"] != null)
            {
                ...
                if (sdr.HasRows)
                {
                    while (sdr.Read())
                    {
                        ...
                        txtDescription.Text = sdr["Descriptions"].ToString();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
            try
            {
                ...
                if (Request.QueryString["id"] != null)
                {
                    ...
                    query = @"Update Jobs set Title=@Title,NoOfPost=@NoOfPost,Descriptions=@Descriptions,Qualification=@Qualification,Experience=@Experience,
Specialization=@Specialization,
LastDateToApply=@LastDateToApply, Salary=@Salary,JobType=@JobType,CompanyName=@CompanyName,"+ concatQuery+@"Website=@Website,Email=@Email,Address=@Address,Country=@Country,State=@State where JobId=@id";
                    type = "updated";
                    cmd = new SqlCommand(query, con);
                ...
                else
                {
                    ...
                    query = @"Insert into Jobs values(@Title,@NoOfPost,@Descriptions,@Qualification,@Experience,@Specialization,@LastDateToApply,
                             @Salary,@JobType,@CopanyName,@CompanyImage,@Website,@Email,@Address,@Country,@State,@CreateDate)";
                    type = "saved"; 
                    ...
                    cmd.Parameters.AddWithValue("@Salary", txtSalary.Text.Trim());
                    cmd.Parameters.AddWithValue("@JobType", ddlJobType.SelectedValue);
                    cmd.Parameters.AddWithValue("@CopanyName", txtCompany.Text.Trim());
                    //cmd.Parameters.AddWithValue("@CompanyImage", txtJobTitle.Text.Trim());
                    cmd.Parameters.AddWithValue("@Website", txtWebsite.Text.Trim());
                    cmd.Parameters.AddWithValue("@Email", txtEmail.Text.Trim());
                    cmd.Parameters.AddWithValue("@Address", txtAddress.Text.Trim());
