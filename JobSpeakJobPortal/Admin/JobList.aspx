<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="JobList.aspx.cs" Inherits="JobSpeakJobPortal.Admin.JobList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-md-12">
        ...
        <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="LastDateToApply" HeaderText="Valid Till" DataFormatString="{0:dd MMMMM yyyy}">
                <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
 ...
 <asp:BoundField DataField="CreateDate" HeaderText="Posted Date" DataFormatString="{0:dd MMMMM yyyy}">
 <ItemStyle HorizontalAlign="Center" />
 </asp:BoundField>
