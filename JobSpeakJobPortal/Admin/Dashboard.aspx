<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="JobSpeakJobPortal.Admin.Dashboard" %>
            ...
            <div class="col-xl-3 col-lg-6">
                <div class="card l-bg-cherry">
                    <div class="card-statistic-3 p-4">
                        ...
                        <div clss="row-align-items-center mb-2 d-flex">
                            <div class="col-8">
            ...
            <div class="col-xl-3 col-lg-6">
                <div class="card l-bg-orange-dark">
                    <div class="card-statistic-3 p-4">
                        ...
                        <div class="mb-4">
                            <h5 class="card-title mb-0">Contacted </h5>
                        </div>
                        <div clss="row-align-items-center mb-2 d-flex">
                            <div class="col-8">
                                <h2 class="d-flex align-items-center mb-0">
